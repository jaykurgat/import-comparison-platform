...
export const CANONICAL_CATEGORY_TAXONOMY: CanonicalCategoryDefinition[] = [
  ...
  { path: ['Electronics', 'Computer Accessories'], keywords: ['keyboard', 'mouse', 'mouse pad', 'webcam', 'usb hub', 'laptop stand', 'laptop sleeve', 'monitor stand', 'computer speaker', 'ssd enclosure', 'card reader', 'memory card reader', 'micro sd card reader', 'usb card reader', 'computer accessory'] },
