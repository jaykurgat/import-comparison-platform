      ...
      <div className="mx-auto grid max-w-[1440px] gap-10 px-4 py-14 sm:px-6 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-4 max-w-sm text-sm leading-7 text-slate-400">
            A Kenyan marketplace designed around clear local pricing and transparent import comparisons.
          </p>
        </div>
        <div>
          ...
          <div className="mt-4 space-y-3 text-sm">
            ...
            <Link className="block hover:text-white" href="/products">Deals</Link>
          </div>
        </div>
        <div>
          <h3 className="text-sm font-black text-white">How it works</h3>
          <div className="mt-4 space-y-3 text-sm">
            <Link className="block hover:text-white" href="/">Compare prices</Link>
            <Link className="block hover:text-white" href="/">Understand landed cost</Link>
          </div>
        </div>
        <div>
