        ...
        <div className="mx-auto max-w-[1440px] px-4 pb-16 sm:px-6">
          <section className="mt-5 grid gap-3 sm:grid-cols-3">
            {[
              ...
              <div key={number} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
          ...
          <section className="mt-12">
            <div className="flex items-end justify-between gap-4">
              ...
              <Link href="/products" className="shrink-0 text-sm font-bold text-emerald-800 hover:underline">View all →</Link>
            </div>
